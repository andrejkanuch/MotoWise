...
export const AnalyticsEvent = {
  ...
  RIDE_FIRST_OVERLAY_SHOWN: 'ride_first_overlay_shown',
  RIDE_FIRST_OVERLAY_DISMISSED: 'ride_first_overlay_dismissed',
  RIDE_ZERO_DISTANCE_SHOWN: 'ride_zero_distance_shown',
  RIDE_MILESTONE_ACHIEVED: 'ride_milestone_achieved',
  // Rides — engagement
