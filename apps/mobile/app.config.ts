    ...
    intentFilters: [
      {
        ...
        data: [
          ...
          { scheme: 'https', host: 'www.motovault.app', pathPrefix: '/ride/' },
          { scheme: 'https', host: 'motovault.app', pathPrefix: '/routes/' },
          { scheme: 'https', host: 'www.motovault.app', pathPrefix: '/routes/' },
          { scheme: 'https', host: 'motovault.app', pathPrefix: '/route/' },
          { scheme: 'https', host: 'www.motovault.app', pathPrefix: '/route/' },
        ],
