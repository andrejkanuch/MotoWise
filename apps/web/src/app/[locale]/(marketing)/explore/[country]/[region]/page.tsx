...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const description = `Explore ${region.routeCount} motorcycle routes in ${region.name}, ${country.name}. Find the best twisty roads, scenic passes, and rides rated by the community.`;
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: { 'x-default': `${BASE_URL}/explore/${countrySlug}/${regionSlug}` },
    },
  };
}
