...
interface DiagnosticsFaqProps {
  items: FaqItem[];
  supportLabel: string;
  supportLink: React.ReactNode;
}

export function DiagnosticsFaq({ items, supportLabel, supportLink }: DiagnosticsFaqProps) {
          ...
          return (
            <div key={question} className="border-b border-neutral-800/50">
              <button
                ...
                aria-controls={`diag-faq-answer-${index}`}
              >
