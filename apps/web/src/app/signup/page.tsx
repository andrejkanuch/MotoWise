    ...
    <div className="flex justify-center items-center min-h-screen bg-neutral-950">
      <div className="w-full max-w-[400px] px-4">
        ...
        <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-8">
          ...
          <p className="text-neutral-400 mb-6">Create Account</p>
          ...
          {success ? (
            ...
            <>
              {error && (
                <p id="signup-error" role="alert" className="text-sm text-danger-500 mb-4">
                  {error}
                </p>
              )}
              ...
              <div className="flex flex-col gap-3 mb-6">
                <button
                  ...
                  className="flex items-center justify-center gap-3 w-full rounded-xl border border-neutral-700 bg-neutral-900 px-4 py-3 text-neutral-50 font-medium transition-colors hover:bg-neutral-800"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 w-full rounded-xl bg-white px-4 py-3 text-neutral-950 font-medium transition-colors hover:bg-neutral-200"
                >
                  <svg
                    className="h-5 w-5"
                    viewBox="0 0 24 24"
              ...
              <form onSubmit={handleSignUp} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="signup-email" className="text-sm font-medium text-neutral-400">
                    Email
                  </label>
                  <input
                    id="signup-email"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="signup-password" className="text-sm font-medium text-neutral-400">
                    Password
                  </label>
                  <input
                    id="signup-password"
