      ...
      >
        ...
        >
          ...
          <div style={{ maxWidth: 520, zIndex: 1 }}>
            ...
            >
              &ldquo;I rented a GS in California last spring and used MotoVault to plan the entire
              PCH. <span style={{ color: t.warm300 }}>The offline GPX export</span> was the only
              thing that worked when cell signal dropped in Big Sur.&rdquo;
            </p>
            <div style={{ marginTop: 28, display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div style={{ fontSize: 13 }}>
                ...
                >
                  BMW R 1250 GS &middot; Milan, Italy
                </span>
              </div>
            </div>
        ...
        >
          ...
          >
            <div style={{ width: '100%', maxWidth: 400 }}>
              ...
              >
                Free forever. No subscription, no ads, no upsells. We don&rsquo;t even ask for a
                credit card.
              </p>
              ...
              {success ? (
                <div
                  style={{
                    marginTop: 28,
                    padding: '20px 24px',
                    background: 'oklch(0.2 0.06 145 / 0.3)',
