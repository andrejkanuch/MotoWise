  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-[400px]">
        ...
        <p className="mt-1 text-sm text-neutral-400">Join thousands of riders</p>

        {success ? (
          <div className="mt-6 rounded-lg border border-green-800/50 bg-green-950/30 p-4">
          ...
          <>
            {error && (
              <p id="signup-error" role="alert" className="mt-4 text-sm text-red-400">
                {error}
              </p>
            )}
