...
type Documents = {
    ...
    "query GetPublicRide($id: String!) {\n  getPublicRide(id: $id) {\n    id\n    userId\n    status\n    name\n    startedAt\n    endedAt\n    distanceM\n    maxSpeedMps\n    avgSpeedMps\n    elevationGain\n    elevationLoss\n    pausedDurationS\n    autoPausedDurationS\n    durationS\n    motorcycleId\n    routePolyline\n    routeThumbnailUri\n    gpsQuality\n    mileageApplied\n    isPublic\n    createdAt\n  }\n}": typeof types.GetPublicRideDocument,
    ...
    "query RouteBySlugDeepLink($country: String!, $region: String!, $slug: String!) {\n  routeBySlug(country: $country, region: $region, slug: $slug) {\n    id\n  }\n}": typeof types.RouteBySlugDeepLinkDocument,
...
const documents: Documents = {
    ...
    "query FuelStopsNearRoute($routeId: ID!, $bikeId: ID) {\n  fuelStopsNearRoute(routeId: $routeId, bikeId: $bikeId) {\n    fuelStops {\n      osmId\n      name\n      lat\n      lng\n    }\n    rangeSummary {\n      effectiveRangeKm\n      stopsRequired\n      summary\n    }\n  }\n}": types.FuelStopsNearRouteDocument,
    ...
    "query RouteBySlugDeepLink($country: String!, $region: String!, $slug: String!) {\n  routeBySlug(country: $country, region: $region, slug: $slug) {\n    id\n  }\n}": types.RouteBySlugDeepLinkDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FuelStopsNearRoute($routeId: ID!, $bikeId: ID) {\n  fuelStopsNearRoute(routeId: $routeId, bikeId: $bikeId) {\n    fuelStops {\n      osmId\n      name\n      lat\n      lng\n    }\n    rangeSummary {\n      effectiveRangeKm\n      stopsRequired\n      summary\n    }\n  }\n}"): (typeof documents)["query FuelStopsNearRoute($routeId: ID!, $bikeId: ID) {\n  fuelStopsNearRoute(routeId: $routeId, bikeId: $bikeId) {\n    fuelStops {\n      osmId\n      name\n      lat\n      lng\n    }\n    rangeSummary {\n      effectiveRangeKm\n      stopsRequired\n      summary\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetPublicRide($id: String!) {\n  getPublicRide(id: $id) {\n    id\n    userId\n    status\n    name\n    startedAt\n    endedAt\n    distanceM\n    maxSpeedMps\n    avgSpeedMps\n    elevationGain\n    elevationLoss\n    pausedDurationS\n    autoPausedDurationS\n    durationS\n    motorcycleId\n    routePolyline\n    routeThumbnailUri\n    gpsQuality\n    mileageApplied\n    isPublic\n    createdAt\n  }\n}"): (typeof documents)["query GetPublicRide($id: String!) {\n  getPublicRide(id: $id) {\n    id\n    userId\n    status\n    name\n    startedAt\n    endedAt\n    distanceM\n    maxSpeedMps\n    avgSpeedMps\n    elevationGain\n    elevationLoss\n    pausedDurationS\n    autoPausedDurationS\n    durationS\n    motorcycleId\n    routePolyline\n    routeThumbnailUri\n    gpsQuality\n    mileageApplied\n    isPublic\n    createdAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query RouteBySlugDeepLink($country: String!, $region: String!, $slug: String!) {\n  routeBySlug(country: $country, region: $region, slug: $slug) {\n    id\n  }\n}"): (typeof documents)["query RouteBySlugDeepLink($country: String!, $region: String!, $slug: String!) {\n  routeBySlug(country: $country, region: $region, slug: $slug) {\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query SearchTypeahead($q: String, $limit: Int) {\n  searchTypeahead(q: $q, limit: $limit) {\n    routes {\n      id\n      name\n      slug\n      countryCode\n      regionCode\n    }\n    places {\n      id\n      name\n      kind\n      countryCode\n      regionCode\n      population\n    }\n  }\n}"): (typeof documents)["query SearchTypeahead($q: String, $limit: Int) {\n  searchTypeahead(q: $q, limit: $limit) {\n    routes {\n      id\n      name\n      slug\n      countryCode\n      regionCode\n    }\n    places {\n      id\n      name\n      kind\n      countryCode\n      regionCode\n      population\n    }\n  }\n}"];
