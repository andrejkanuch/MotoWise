...
type Documents = {
    ...
    "query GetComments($rideId: ID, $routeId: ID, $groupRideId: ID, $first: Int, $after: String) {\n  getComments(\n    rideId: $rideId\n    routeId: $routeId\n    groupRideId: $groupRideId\n    first: $first\n    after: $after\n  ) {\n    comments {\n      id\n      text\n      createdAt\n      flaggedCount\n      parentCommentId\n      author {\n        id\n        displayName\n        publicUsername\n        avatarUrl\n      }\n      replies {\n        id\n        text\n        createdAt\n        flaggedCount\n        parentCommentId\n        author {\n          id\n          displayName\n          publicUsername\n          avatarUrl\n        }\n      }\n    }\n    hasNextPage\n    endCursor\n    totalCount\n  }\n}": typeof types.GetCommentsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetComments($rideId: ID, $routeId: ID, $groupRideId: ID, $first: Int, $after: String) {\n  getComments(\n    rideId: $rideId\n    routeId: $routeId\n    groupRideId: $groupRideId\n    first: $first\n    after: $after\n  ) {\n    comments {\n      id\n      text\n      createdAt\n      flaggedCount\n      parentCommentId\n      author {\n        id\n        displayName\n        publicUsername\n        avatarUrl\n      }\n      replies {\n        id\n        text\n        createdAt\n        flaggedCount\n        parentCommentId\n        author {\n          id\n          displayName\n          publicUsername\n          avatarUrl\n        }\n      }\n    }\n    hasNextPage\n    endCursor\n    totalCount\n  }\n}"): (typeof documents)["query GetComments($rideId: ID, $routeId: ID, $groupRideId: ID, $first: Int, $after: String) {\n  getComments(\n    rideId: $rideId\n    routeId: $routeId\n    groupRideId: $groupRideId\n    first: $first\n    after: $after\n  ) {\n    comments {\n      id\n      text\n      createdAt\n      flaggedCount\n      parentCommentId\n      author {\n        id\n        displayName\n        publicUsername\n        avatarUrl\n      }\n      replies {\n        id\n        text\n        createdAt\n        flaggedCount\n        parentCommentId\n        author {\n          id\n          displayName\n          publicUsername\n          avatarUrl\n        }\n      }\n    }\n    hasNextPage\n    endCursor\n    totalCount\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
