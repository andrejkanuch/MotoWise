 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CompleteMaintenanceTask($id: String!, $input: CompleteMaintenanceTaskInput) {\n  completeMaintenanceTask(id: $id, input: $input) {\n    id\n    status\n    completedAt\n    completedMileage\n    cost\n    partsCost\n    laborCost\n    currency\n  }\n}"): (typeof documents)["mutation CompleteMaintenanceTask($id: String!, $input: CompleteMaintenanceTaskInput) {\n  completeMaintenanceTask(id: $id, input: $input) {\n    id\n    status\n    completedAt\n    completedMileage\n    cost\n    partsCost\n    laborCost\n    currency\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
