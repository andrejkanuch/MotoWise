...
export const CreateMaintenanceTaskSchema = z.object({
  ...
  // reading at that time. All mileage fields (targetMileage/completedMileage)
  // are canonical KILOMETRES — the client converts from the user's display unit
  // before sending (docs/plans/odometer-unit-normalization.md).
