{/* MotoVault blog draft — SPEC / maintenance mode — status=draft, spec_data=true, is_safety_critical=true */}
{/* Target keyword: "mt-07 service intervals" — slug: mt-07-service-intervals */}
...
- [Yamaha MT-07 / FZ-07 (2015+) Maintenance Schedule — maintenanceschedule.com](https://maintenanceschedule.com/yamaha-mt-07-fz-07-maintenance/) — full US and European owner's-manual maintenance charts, torque values, tyre pressures, chain slack, consumable part numbers (transcribed from the official 2015–2021 Yamaha owner's manuals it links).
- [Yamaha MT-07 Engine Oil Capacity & Specifications — manualonline.net](https://www.manualonline.net/2024/02/yamaha-mt-07-engine-oil-capacity-and.html) — verbatim owner's-manual oil-change procedure: capacity 2.60 L (with filter) / 2.30 L, drain bolt 43 N·m, oil filter 17 N·m, oil grade 10W-40 JASO MA.
- [Yamaha MT-07 / FZ-07 Oil Change Guide — MTP-Racing GmbH](https://mtp-racing.de/blog/yamaha-mt-07-oil-change) — independent master-mechanic reference confirming oil capacity (2.6 L with filter), 10W-40 JASO MA/MA2, torque values, and the 2014–2026 model-year/generation breakdown.
- [Yamaha MT-07 Owner's Manual — ManualsLib](https://www.manualslib.com/manual/837941/Yamaha-Mt-07.html) — official owner's-manual periodic maintenance and lubrication chart.
- [Yamaha Owner's Manuals portal](https://www.yamahamotorsports.com/yamaha-manuals) — official source for the model-year-specific MT-07 owner's manual.
